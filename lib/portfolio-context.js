    ...
    projects: [
        {
            ...
            description: "Full-stack AI code review platform with streaming reviews (SSE), multiple review templates, GitHub PR review, AI chat with LaTeX rendering, PDF export, and Roast Mode.",
            techStack: ["Next.js 15", "TypeScript", "MongoDB", "NextAuth v5", "Gemini AI + Groq", "Monaco Editor", "Recharts"],
            liveUrl: "https://code-review-ai-blond.vercel.app",
            githubUrl: "https://github.com/Chakshita2123/Code-Review-AI",
            highlights: ["Streaming SSE reviews", "GitHub PR integration", "LaTeX rendering", "PDF export", "Roast Mode"]
        },
        {
            id: 2,
            ...
            techStack: ["Node.js", "Express", "MongoDB", "React", "Vite", "Capacitor (Android)", "Gemini Vision API", "Groq"],
            ...
            highlights: [
                ...
                "Per-subject Starting Balance tracking"
            ]
        },
        {
            id: 3,
            ...
            highlights: ["Resume–JD alignment scoring", "Skill gap analysis", "AI-powered career insights"]
        },
        {
            id: 4,
            ...
            description: "Data analytics dashboard for Flipkart product data — visualising pricing trends, category breakdowns, and customer review sentiment through interactive Recharts and a Python/pandas data pipeline.",
            techStack: ["React", "Python", "pandas", "FastAPI", "Recharts"],
            githubUrl: "https://github.com/Chakshita2123/Flipkart-Analytics-Hub",
            status: "In Progress",
            highlights: ["Pricing trend visualisation", "Sentiment analysis", "Interactive Recharts dashboard"]
        },
        {
            id: 5,
            ...
            description: "Travel planning platform built around a real ML core — a trip cost predictor trained with scikit-learn/XGBoost — combined with Gemini/Groq for personalised itinerary generation. Currently in progress.",
        ...
        },
        {
            ...
            highlights: ["Embedded AI assistant", "Real project data", "Full MARKD case study", "Clean design system"]
        }
    ]
};
...
- projects with real URLs and details (Code Review AI, Attendance Tracker MARKD with Android APK and case study, Career Lens, Flipkart Analytics Hub, Journey Curator AI, Developer Portfolio)
- certifications
