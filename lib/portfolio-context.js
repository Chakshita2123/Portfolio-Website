...
export function getContextPrompt(context) {
    switch (context) {
        case 'recruiter':
            return `\n\nThe visitor is a recruiter. ${portfolioContext.forRecruiters}`;
        case 'developer':
            return `\n\nThe visitor is a developer. ${portfolioContext.forDevelopers}`;
        case 'founder':
            return `\n\nThe visitor is a founder/startup person. ${portfolioContext.forFounders}`;
        case 'projects':
            return `\n\nThe visitor is on the Projects page. Focus on recommending relevant projects based on their interests.`;
        default:
            return '';
    }
}
